...
for you. You can then just type "make clean" and hit enter to remove the executable smallsh file after 
compiling if desired. Alternatively, you can compile the smallsh.c file by putting the file in some directory on 
